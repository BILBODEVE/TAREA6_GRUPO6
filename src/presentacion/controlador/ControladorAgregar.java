...
public class ControladorAgregar implements ActionListener {
	...
	private void agregarPersona() {
		...
		if (nombre.isEmpty() || apellido.isEmpty() || dni.isEmpty()) {
			JOptionPane.showMessageDialog(ventanaAgregarPersona, "Todos los campos son obligatorios.", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return;
		}

		if (pni.verificarPersonaExiste(dni)) {
			JOptionPane.showMessageDialog(ventanaAgregarPersona, "El DNI ingresado ya se encuentra registrado.",
		...
		if (exito) {
			...
			JOptionPane.showMessageDialog(ventanaAgregarPersona, "Error al agregar la persona.", "Error",
